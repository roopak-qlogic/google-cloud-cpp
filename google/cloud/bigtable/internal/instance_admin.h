 ...
 public:
  ...
  std::shared_ptr<AsyncOperation> AsyncGetIamPolicy(
    ...
    auto retry = std::make_shared<Retry>(
        ...
        TransformResponseHelper(std::forward<Functor>(callback)));
    return retry->Start(cq);
  }
